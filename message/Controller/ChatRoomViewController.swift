...
class ChatRoomViewController: UIViewController {
    ...
    @objc private func keyboradWillShow(notificattion: NSNotification) {
        guard let userInfo = notificattion.userInfo else { return }
        ...
        if let keyboardFrame = (userInfo[UIResponder.keyboardFrameEndUserInfoKey] as AnyObject).cgRectValue {
            ...
            print(chatRoomTableView.contentOffset.y)
    ...
    @objc private func keyboradWillHide() {
        print("とじた")
